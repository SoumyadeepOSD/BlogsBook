...
export const NavbarSection = () => {
    ...
    return (
        <div className="bg-slate-800 w-[80%] h-[20%] flex flex-row items-center justify-between px-5 my-5 rounded-lg" style={{ backdropFilter: 'blur(2px)' }}>
            <picture>
            ...
            {!isAuthenticated &&
                (<SignInButton>
                    <Button className="bg-white text-black rounded-sm px-5 hover:bg-slate-300">
